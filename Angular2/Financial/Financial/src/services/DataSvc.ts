...
export class DataSvc {
    ...
    getData(): any[] {
        ...
        for (let i = 0; i < this._companies.length; i++) {
            ...
            let company = this._companies[i],
                bid = DataSvc.randBetween(1, 100000) / 100,
                ask = bid + DataSvc.randBetween(0, 100) / 100;
            data.push({
                ...
                ask: ask,
                lastSale: bid,
                bidSize: DataSvc.randBetween(10, 500),
                askSize: DataSvc.randBetween(10, 500),
                lastSize: DataSvc.randBetween(10, 500),
                volume: DataSvc.randBetween(10000, 20000),
                quoteTime: now,
                tradeTime: now,
                askHistory: [ask, ask],
                bidHistory: [bid, bid],
