...
var AppSorter_1 = require("./components/AppSorter");
var GlbzPipe_1 = require("./pipes/GlbzPipe");
var appBase_1 = require("./appBase");
'use strict';
// The application root component.
var AppCmp = /** @class */ (function (_super) {
    __extends(AppCmp, _super);
    function AppCmp() {
...
var AppModule = /** @class */ (function () {
    ...
    AppModule = __decorate([
        core_1.NgModule({
            ...
            declarations: [GlbzPipe_1.GlbzPipe, AppSorter_1.AppSorter, AppCmp],
            providers: [],
            bootstrap: [AppCmp]
        })
    ], AppModule);
