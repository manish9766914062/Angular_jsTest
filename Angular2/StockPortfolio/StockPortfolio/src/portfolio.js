...
var Portfolio = /** @class */ (function () {
    ...
    Portfolio.prototype.getCompany = function (symbol) {
        var self = this, protocol = 'https', c = Portfolio._companyCache[symbol], url = '://www.quandl.com/api/v3/datasets/WIKI/', token = 'rX6NsszGKZp32RUbA7SR', startDate = wjcCore.Globalize.formatDate(new Date("01/01/2008"), "yyyy-MM-dd"), endDate = wjcCore.Globalize.formatDate(new Date(), "yyyy-MM-dd");
