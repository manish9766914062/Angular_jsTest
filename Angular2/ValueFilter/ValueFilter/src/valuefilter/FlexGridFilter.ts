...
import * as wjcSelf from './FlexGridFilter';
...
//module wijmo.grid.valuefilter {
    ...
    export class FlexGridFilter {
         ...
         */
        getColumnFilter(col: wjcGrid.Column, create = true): ColumnFilter {
         ...
         */
        filterApplied = new wjcCore.Event();
        /**
        ...
        _formatItem(sender: wjcGrid.FlexGrid, e: wjcGrid.FormatItemEventArgs) {
        ...
        _mousedown(e) {
            if (this._hasAttribute(e.target, FlexGridFilter._WJA_FILTER)) {
                ...
                if (ht.cellType == wjcGrid.CellType.ColumnHeader) {
                    ...
                    e.preventDefault();
                    if (e.type == 'mousedown') { // toggle editor on mousedown
