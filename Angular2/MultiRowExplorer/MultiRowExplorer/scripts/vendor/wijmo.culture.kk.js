...
(function (wijmo) {
    ...
    wijmo.culture = window['wijmo'].culture = {
        ...
        Viewer: {
            ...
            zoomOut: 'Кішілеу',
            zoomIn: 'Ірілеу',
            rubberbandTool: 'Іріктеу арқылы Zoom',
            magnifierTool: 'үлкейткіш',
            rotatePage: 'Page бұру',
            rotateDocument: 'құжатты айналдырыңыз',
            exports: 'Экспорттау',
            ...
            navigatorPosition: 'Навигатор Қызметі',
            ...
            checkMark: '\u2713',
            exportOk: 'Экспорттау',
            cannotSearch: 'Іздеу көрсетілуі үшін құжат көзін қажет етеді.',
