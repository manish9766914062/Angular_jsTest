...
export class DataSvc {
    ...
    getOrderDetail(count) {
        ...
        for (var i = 0; i < count; i++) {
            ...
            orderDetails[i] = {
                orderId: 'PT-0000' + (i + 1),
                partId: DataSvc.randBetween(10000, 99999).toString(),
                handlingId: DataSvc.randBetween(100, 999).toString(),
                processingStatus: 'Testing',
                purchaseId: DataSvc.randBetween(1000, 9999).toString(),
                completed: '',
                orderDate: orderDate,
                ...
                quantity1: DataSvc.randBetween(100, 999),
                quantity2: DataSvc.randBetween(100, 999),
                quantity3: DataSvc.randBetween(100, 999),
                unit: 'copy',
    ...
    getOrders(count) {
        var orders = [];
        for (var i = 0; i < count; i++) {
            var product = this.products[Math.floor(Math.random() * 6)],
                quantity = DataSvc.randBetween(100, 999),
    ...
    getSalesSlip(count) {
        ...
        for (var i = 0; i < count; i++) {
            var product = this.products[Math.floor(Math.random() * 6)],
                quantity = DataSvc.randBetween(10, 50),
