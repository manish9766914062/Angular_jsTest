...
import { DataSvc } from './services/DataSvc';
    ...
    export class ExcellikeSheetCmp implements OnInit {
                    ...
                    for (var i = 0; i < flexSheet.sheets.length; i++) {
                        ...
                        switch (flexSheet.sheets[i].name) {
                            ...
                            case 'Formulas':
                                ...
                                break;
                            //case 'Table':
                            //    self._generateTableSheet(flexSheet);
                            //    break;
                        }
                    }
        ...
        lbChartTypesInit(lbChartTypes: wjcInput.ListBox) {
            var self = this;
            if (lbChartTypes) {
                lbChartTypes.hostElement.addEventListener('mouseup', () => {
                    setTimeout(() => {
                        self._addChart();
                    }, 10);
                });
                lbChartTypes.lostFocus.addHandler(() => {
        ...
        private _getSelectedTable(selection: wjcGrid.CellRange) {
            var rowIndex: number,
                colIndx: number,
