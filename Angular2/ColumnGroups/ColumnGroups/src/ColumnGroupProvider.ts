...
import * as wjcSelf from './ColumnGroupProvider';
...
//module wijmo.grid.columngroups {
    ...
    export class ColumnGroupProvider {
        ...
        constructor(grid: wjcGrid.FlexGrid, columnGroups: any[]) {
            ...
            grid.formatItem.addHandler(function (s, e: wjcGrid.FormatItemEventArgs) {
            ...
            grid.sortingColumn.addHandler((s, e: wjcGrid.CellRangeEventArgs) => {
                if (this._selectOnClick) {
                    e.cancel = true;
                }
            });
            grid.draggingColumn.addHandler((s, e: wjcGrid.CellRangeEventArgs) => {
                if (this._selectOnClick) {
                    e.cancel = true;
                }
            });
