...
module wijmo {
    ...
    export class DragDropTouch {
        ...
        /*private*/ _imgOffset: wjcCore.Point;
        ...
        _touchstart(e: any) {
            if (this._shouldHandle(e)) {
                ...
                var src = <HTMLElement>wjcCore.closest(e.target, '[draggable]');
        ...
        _getPoint(e: any, page?: boolean): wjcCore.Point {
            if (e && e.touches) {
                e = e.touches[0];
            }
