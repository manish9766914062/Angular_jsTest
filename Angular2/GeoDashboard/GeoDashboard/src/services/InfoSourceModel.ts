...
export class InfoSource {
    ...
    legends: any[];
    shortList: any[];
    URL_FORMAT = 'http://services.arcgisonline.com:80/ArcGIS/rest/services/Demographics/SHORT_URL/MapServer';
    ...
    private getData(currentExtent: any, infoScale: string, serviceCallback: Function) {
 ...
 */
    private gotData(featureSet: any, serviceCallback: Function) {
