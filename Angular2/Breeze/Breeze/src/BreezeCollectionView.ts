...
import * as wjcSelf from './BreezeCollectionView';
...
"use strict";
     ...
     */
export class BreezeCollectionView extends wjcCore.CollectionView{        
        _manager: any;
        _entityQuery: any;
         ...
         */
        querySucceeded = new wjcCore.Event();
        /**
         ...
         */
        saveSucceeded = new wjcCore.Event();
        /**
        ...
        private _getServerSortQuery(query: any): any {
            ...
            if (sdCount > 0 && this.canSort && this.sortOnServer) {
                for (var i = 0; i < sdCount; i++) {
                    var sd = <wjcCore.SortDescription>this.sortDescriptions[i];
                    strSort += sd.property;
                    if (!sd.ascending) {
                        strSort += ' desc';
                    }
        ...
        private _asValueFilterPredicate(vf: wjcGridFilter.ValueFilter): any {
            var col = vf.column,
                fld = col.binding,
                predicate: any,
                p: any;
        ...
        private _asConditionFilterPredicate(cf: wjcGridFilter.ConditionFilter): any {
        ...
        private _asConditionPredicate(cf: wjcGridFilter.ConditionFilter, cond: wjcGridFilter.FilterCondition): any {
            var op = null,
                not = null;
    ...
    export class QueryEventArgs extends wjcCore.EventArgs{
        _data: any;
