...
var SortManager = /** @class */ (function () {
    ...
    SortManager.prototype.commit = function (save) {
        ...
        for (var i = 0; i < arr.length; i++) {
            var flex = wjcCore.Control.getControl(arr[i]);
            flex.finishEditing();
        }
        // save changes
        if (save) {
            this._view.deferUpdate(function () {
                ...
                for (var i = 0; i < arr.length; i++) {
                    if (_this.properties.indexOf(arr[i].property) > -1 && wjcCore.isBoolean(arr[i].ascending)) {
    ...
    SortManager.prototype.getError = function () {
        if (this._sorts) {
            ...
            for (var i = 0; i < arr.length; i++) {
                ...
                if (!wjcCore.isBoolean(arr[i].ascending))
