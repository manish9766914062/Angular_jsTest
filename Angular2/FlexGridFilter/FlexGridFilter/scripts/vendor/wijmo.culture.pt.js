...
(function (wijmo) {
    ...
    wijmo.culture = window['wijmo'].culture = {
        ...
        Viewer: {
            ...
            zoomOut: 'Reduzir',
            zoomIn: 'Ampliar',
            rubberbandTool: 'Zoom por seleção',
            magnifierTool: 'Lupa',
            rotatePage: 'Girar página',
            rotateDocument: 'Girar o documento',
            exports: 'Exportar',
            ...
            navigatorPosition: 'Posição do navegador',
            ...
            checkMark: '\u2713',
            exportOk: 'Exportação…',
            cannotSearch: 'A pesquisa exige que uma fonte de documento seja especificada.',
