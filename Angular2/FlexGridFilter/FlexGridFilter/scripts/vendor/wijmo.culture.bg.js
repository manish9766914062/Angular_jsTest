...
(function (wijmo) {
    ...
    wijmo.culture = window['wijmo'].culture = {
        ...
        Viewer: {
            ...
            moveTool: '"Преместване" инструмент',
            ...
            zoomOut: 'Намали',
            zoomIn: 'Увеличи',
            rubberbandTool: 'Увеличете мащаба по селекция',
            magnifierTool: 'лупа',
            rotatePage: 'Завъртане на страницата',
            rotateDocument: 'Завъртете документа',
            ...
            navigatorPosition: 'Позиция на навигатора',
            ...
            showZoomBar: 'Лента за увеличение',
            searchPrev: 'Търси предишен',
            searchNext: 'Търси следващ',
            checkMark: '\u2713',
            exportOk: 'Експортиране…',
            cannotSearch: 'Търсене изисква да се посочи източник на документи.',
